...
#' the example of the the drought index in the univaraite case. 
#' It also represents other drought indices compuated in the similar way as SPI.
#' 
...
#' fit$Prob # Get the empirical probability
